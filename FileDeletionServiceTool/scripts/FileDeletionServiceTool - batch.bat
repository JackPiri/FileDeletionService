...
REM "DISK=%s|%d" for disk name, minimum free space in GBs
...
start "FileDeletionServiceTool" "FileDeletionServiceTool.exe" "TRIGGERTIME=1" "DISK=C:|100" "FOLDER=C:|C:\Users\MyUser\Desktop|false|false|0|0" "FILE=C:|C:\Users\MyUser\Desktop|.txt|1"
